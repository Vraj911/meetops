    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-semibold">
          {isAuthenticated ? "Accept Invitation" : "You've been invited to join"}
        </h1>
        <p className="text-muted-foreground">Join {inviteData.workspaceName}</p>
      </div>
      ...
      <Card className="p-6 space-y-4">
        <div className="space-y-3">
          <div>
            ...
            <p className="text-lg font-medium">{inviteData.workspaceName}</p>
          </div>

          <div>
            <label className="text-sm font-medium text-muted-foreground">Invited by</label>
            <p className="text-lg">{inviteData.invitedBy}</p>
            <p className="text-sm text-muted-foreground">{inviteData.invitedByEmail}</p>
          </div>
        ...
        <div className="flex gap-3 pt-4">
          {isAuthenticated ? (
            ...
            <>
              <Button onClick={() => navigate(ROUTES.SIGNUP)} className="flex-1">
