...
export function getMockInviteData() {
  return {
...
export function getMockWorkspaceStats(): WorkspaceStats {
  return {
...
export function getMockJiraIntegration(): JiraIntegration {
  return {
    status: 'connected',
...
export function getMockCalendarIntegration(): CalendarIntegration {
  return {
...
export function getMockApiAccess(): ApiAccess {
  return {
    status: 'available',
...
export function getMockMeeting(): Meeting {
  return {
    id: 'mtg_001',
...
export function getMockTranscript(): TranscriptLine[] {
  return [
    {
      timestamp: '14:32',
      speaker: 'Alice',
...
export function getMockSummary(): MeetingSummary {
  return {
    keyThemes: [
...
export function getMockActionItems(): ActionItem[] {
  return [
    {
      id: 'ai_001',
...
export function getMockProcessingSteps(): ProcessingStep[] {
  return [
    {
      id: 'step_001',
      name: 'Transcribing',
...
export function getMockSyncResult(): SyncResult {
  return {
    success: true,
...
export function getMockAiPrompts(): AiPrompt[] {
  return [
    {
      id: 'prompt_001',
      icon: '🔍',
...
export function getMockAiRefinementResult() {
  return {
...
export function getMockDocsContent() {
  return {
    sections: [
